...
class DatePickerWidgetWithActionButtons extends StatefulWidget {
  DatePickerWidgetWithActionButtons({
    ...
    if (config.calendarViewMode == DatePickerWidgetMode.scroll) {
      assert(
        ...
        'scrollViewConstraint with maxHeight must be provided when used withDatePickerWidgetWithActionButtons under scroll mode',
      );
    }
  }
  ...
  final DatePickerWidgetWithActionButtonsConfig config;
  ...
  @override
  State<DatePickerWidgetWithActionButtons> createState() =>
      _DatePickerWidgetWithActionButtonsState();
}

class _DatePickerWidgetWithActionButtonsState
    extends State<DatePickerWidgetWithActionButtons> {
  ...
  void didUpdateWidget(
      covariant DatePickerWidgetWithActionButtons oldWidget) {
